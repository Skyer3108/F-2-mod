...
// const api = "52cfc6f295dc14cb0448c43506812757"
...
function detailData(result) {
  ...
  <div class="top">
          ...
          <p class="para-2">Here is your current location</p>
          <div class="latlong">
          ...
          height="270"
          frameborder="0"
          style="border:0;width: 95vw;
          height: 65vh;margin-top:30px; border-radius:1rem"></iframe>
          </div>
        </div>
  <div class="down">
          <div>
